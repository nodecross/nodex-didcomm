...
use crate::{common::runtime, keyring::secp256k1::Secp256k1};
...
pub mod tests {
    ...
    pub fn test_sign() {
        ...
        let result = Signer::sign(&message(), &context).unwrap();
    ...
    pub fn test_verify() {
        ...
        let result = Signer::verify(&message(), &digest(), &context).unwrap();
        assert!(result)
    }
}
