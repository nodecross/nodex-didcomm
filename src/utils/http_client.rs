...
impl HttpClient {
    pub fn new(_config: &HttpClientConfig) -> Result<Self, NodeXDidCommError> {
    ...
    pub async fn get(&self, _path: &str) -> Result<reqwest::Response, NodeXDidCommError> {
    ...
    pub async fn post(
        ...
        _path: &str,
        body: &str,
    ) -> Result<reqwest::Response, NodeXDidCommError> {
        let url = self.base_url.join(_path);
    ...
    #[allow(dead_code)]
    pub async fn put(&self, _path: &str) -> Result<reqwest::Response, NodeXDidCommError> {
        let url = self.base_url.join(_path);
    ...
    #[allow(dead_code)]
    pub async fn delete(&self, _path: &str) -> Result<reqwest::Response, NodeXDidCommError> {
        let url = self.base_url.join(_path);
